        ...
        if country == 'nl':
            ...
            try:
                if run_pipeline:
                    ...
                    if paging_ready:
                        urls_available = await collect_profile_endpoints(enabled=True)
                        if urls_available:
                    ...
                    await collect_profile_endpoints(enabled=False)
